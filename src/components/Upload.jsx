...
export default function Upload() {
  ...
  return (
    <div className="pb-16">
      <h1 className="p-1 text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent py-6 md:py-16">
